...
- `GET /system/diagnostics`: sanitized env presence, loaded env files, cluster/RPC/program status, database URL health, Helius key source/reachability, and warnings. Secrets are never returned.
