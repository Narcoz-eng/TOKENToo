...
Current `programs/vaultx/tests/vaultx.ts` contains TODO markers for these cases. Replace them with full tests before calling the Anchor program launch-ready.
