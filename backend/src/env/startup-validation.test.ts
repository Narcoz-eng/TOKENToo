...
const ENV_KEYS = [
  ...
  "COMMUNITY_CREATION_FEE_LAMPORTS",
  "COMMUNITY_CREATION_FEE_WALLET",
  "PROTOCOL_TREASURY_WALLET",
  "COMMUNITY_CREATION_WHALE_MIN_RAW",
  "STRATEGY_EXECUTION_PROVIDER",
  "STRATEGY_WORKER_SECRET",
  "ENABLE_LOCAL_STAKING_ACCOUNTING",
  "ENABLE_PRODUCTION_STAKING",
  "ASSET_STORAGE_PROVIDER",
  "FINAL_ASSET_STORAGE_PROVIDER",
  "FINAL_RENDER_STORAGE_ROOT",
  "FINAL_RENDERER_VERSION",
  "FINAL_PRODUCTION_ASSETS_APPROVED",
  "APPROVED_TRAIT_MANIFEST_URI",
  "APPROVED_TRAIT_MANIFEST_HASH",
  "FINAL_ASSET_PROVENANCE_HASH",
